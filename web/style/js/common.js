...
function format_path(str, editorPath) {
    str = str.replace(/%%EDITORPATHTOKEN%%/g, editorPath);
    return str;
}
function format_quot(str) {
    str = str.replace(/"/g, "MAS_QUOT");
    return str;
}
function back_quot(str) {
    str = str.replace(/MAS_QUOT/g, "\"");
    return str;
}
...
function date(format, timestamp) {
    ...
    timestamp = Number(temp.substring(0, temp.length - 3));
