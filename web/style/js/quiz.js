(function ($) {
    $.fn.jQuiz = function (settings) {
        ...
        //question nav
        superContainer.find('.question-nav a:eq(0) span').css({
            "height": "45px",
            "width": "45px",
            "border-color": "red"
        });
        superContainer.find('.question-nav a').click(function () {
            ...
            $(this).parents(".question-nav").find("a span").css({
                "height": "40px",
                "width": "40px",
                "border-color": "#F6F6F6"
            });
        ...
        superContainer.find('.nav-next').click(function () {
            ...
            superContainer.find(".question-nav a span").eq(index + 2).css({
                "height": "45px",
                "width": "45px",
                "border-color": "red"
            });
        ...
        superContainer.find('.nav-prev').click(function () {
            ...
            superContainer.find(".question-nav a span").eq(index).css({
                "height": "45px",
                "width": "45px",
                "border-color": "red"
            });
        ...
        $(".retake").click(function () {
            ...
            $(this).siblings(".checkAnswer").show().removeAttr("disabled");
